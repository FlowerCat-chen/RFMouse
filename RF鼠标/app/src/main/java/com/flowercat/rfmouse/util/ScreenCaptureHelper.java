/*
package com.flowercat.a3plus.util;
...
import com.flowercat.a3plus.ui.PermissionRequestActivity;
...
public class ScreenCaptureHelper {
    ...
    private void createVirtualDisplay() throws ScreenCaptureException {
        int width = mMetrics.widthPixels;
        int height = mMetrics.heightPixels;
    ...
    public void stopRecording() {
        ...
        try {
            ...
            if (recordingDuration < MIN_RECORDING_DURATION_MS) {
                ...
                if (mRecordingCallback != null) {
                    mRecordingCallback.onRecordingStop(null); // 返回null表示录制无效
                }
            } else {
                if (mRecordingCallback != null) {
                    mRecordingCallback.onRecordingStop(mVideoFilePath);
                }
            }
            ...
            if (mRecordingCallback != null) {
                mRecordingCallback.onRecordingError("录屏停止失败: " + e.getMessage());
            }
            // 即使异常也尝试释放资源
            releaseRecorder();
        } finally {
