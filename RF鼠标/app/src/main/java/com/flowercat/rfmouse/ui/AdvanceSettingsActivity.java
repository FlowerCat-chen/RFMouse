...
public class AdvanceSettingsActivity extends Activity {
	...
	private RelativeLayout l1,l2,l3,l4,l5,rl_keepalive;
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		rl_keepalive = findViewById(R.id.rl_keep_alive);
    ...
    private void loadSavedStates() {
        ...
        switch5.setChecked(SPUtil.getBoolean(SPUtil.KEY_HOME_KEY_LOCK, false));
    ...
    private void setupSwitchListeners() {
		...
		rl_keepalive.setOnClickListener(new OnClickListener(){

				@Override
				public void onClick(View v) {
					Intent hello = new Intent (AdvanceSettingsActivity.this,KeepAliveConfigActivity.class);
					startActivity(hello);  
				}
			});
