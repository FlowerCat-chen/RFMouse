...
public final class Workarounds {
    ...
    private static void fillAppInfo() {
        try {
            ...
            EasyLog.logToFile("Could not fill app info: " + throwable.getMessage());
        }
    }
    ...
    private static void fillAppContext() {
        try {
            ...
            // this is a workaround, so failing is not an error
            EasyLog.logToFile("Could not fill app context: " + throwable.getMessage());
        }
    }
    ...
    private static void fillConfigurationController() {
        try {
            ...
            EasyLog.logToFile("Could not fill configuration: " + throwable.getMessage());
        }
    }
    ...
    static Context getSystemContext() {
        try {
            ...
            // this is a workaround, so failing is not an error
            EasyLog.logToFile("Could not get system context: " + throwable.getMessage());
            return null;
        }
    }
